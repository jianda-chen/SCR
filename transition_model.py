...
class ProbabilisticTransitionModel(nn.Module):
    ...
    def __init__(self, encoder_feature_dim, action_shape, layer_width, max_sigma=1e1, min_sigma=1e-4):
        super().__init__()
...
class EnsembleOfProbabilisticTransitionModels(object):
    ...
    def __init__(self, encoder_feature_dim, action_shape, layer_width, ensemble_size=5):
        self.models = [ProbabilisticTransitionModel(encoder_feature_dim, action_shape, layer_width,)
